...
export default function GamePage() {
  ...
  return (
    <div className="bg-[url('/bg.jpg')] bg-bottom bg-no-repeat min-h-screen text-white font-extrabold text-2xl p-4 font-serif">
      ProgressBee
      ...
      <div className="flex flex-col items-center justify-center mt-16">
        ...
        {stageTransitionMessage && <div className="text-slate-800 pt-4 mt-8 my-4">{stageTransitionMessage}</div>}
      </div>
    </div>
  );
}
